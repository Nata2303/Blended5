const o={openModal:document.querySelectorAll("[data-modal-open]"),backdrop:document.querySelector("[data-backdrop]")},l=`<div class="modal room-modal">
  ...
  </div>`;o.openModal.forEach(e=>{e.addEventListener("click",a)});function a(e){o.backdrop.classList.toggle("activ"),o.backdrop.innerHTML+=l,document.querySelector("[data-close-modal]").addEventListener("click",t);function t(r){o.backdrop.classList.toggle("activ"),o.backdrop.innerHTML=""}}
